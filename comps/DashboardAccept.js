            ...
            <View style={DashStyle.pending}>
                ...
                <View style={DashStyle.innerPendingBox} >
                    <View style={DashStyle.innerPendingBox}>
                        {/* Date bubble below*/}
                        <Image
                                style={{ marginRight: 50,marginLeft:20, width: 50, height: 50, borderRadius: 50 }}
                        ...
                        <View style={DashStyle.pendingDetail}>
                            ...
                            {/* time details below*/}
                            <Text style={{ color: 'grey' }}>5:00 pm</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={DashStyle.innerPendingBox} >
                    <View style={DashStyle.innerPendingBox}>
                        ...
                        <View style={DashStyle.pendingDetail}>
                            {/* Foodbank name below*/}
                            <Text style={{ color: '#066a87', fontSize: 18 }}>Whole Foods</Text>
                            {/* time details below*/}
                            <Text style={{ color: 'grey' }}>3:00 pm to 7:00 pm</Text>
                        </View>
                    </View>
